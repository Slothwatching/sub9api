<template>
  <!-- Row 1: Core Stats -->
  <div class="dashboard-core grid grid-cols-2 lg:grid-cols-4">
    <!-- Balance -->
  ...
  <!-- Row 2: Token Stats -->
  <div class="dashboard-detail grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
    <!-- Today Tokens -->
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-icon">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-sm text-primary-700 dark:text-primary-300" :title="t('dashboard.actual')">
