export default {
    ...
    groups: {
      ...
      modelAllowlist: {
        compatibilityHint: 'Request restrictions are opt-in and independent of the display list.',
      ...
      modelsList: {
        title: 'Model Display List',
        hint: 'Controls model discovery and ordering only. It does not restrict API requests. An enabled request allowlist still applies.',
        moveUp: 'Move up',
        moveDown: 'Move down',
        modelId: 'Model ID',
      },
