  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <GroupModelDisplaySettings v-model="createModelsListConfig" :candidates="createModelAllowlistState.items.map(item => item.id)" :loading="createModelAllowlistLoading" />
    ...
    >
      ...
      >
        ...
        <GroupModelDisplaySettings v-model="editModelsListConfig" :candidates="editModelAllowlistState.items.map(item => item.id)" :loading="editModelAllowlistLoading" />
...
const createModelsListConfig = ref({ enabled: false, models: [] as string[] });
const editModelsListConfig = ref({ enabled: false, models: [] as string[] });
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editModelsListConfig.value = { enabled: group.models_list_config?.enabled ?? false, models: [...(group.models_list_config?.models ?? [])] };
